...
import "../index.css"; // Ensure styles are loaded (reuse student base styles where applicable or add specific if needed)
...
const DosenLayout = () => {
  ...
  const navItems = [
    { path: "/dosen", icon: Home, label: "Beranda" },
    { path: "/dosen/jadwal", icon: BookOpen, label: "Jadwal" },
    { path: "/dosen/nilai", icon: Edit3, label: "Input Nilai" },
    { path: "/dosen/profil", icon: User, label: "Profil Saya" },
  ];
  ...
  return (
    <div className="student-dashboard">
      ...
      <aside className="student-sidebar">
        <div className="student-sidebar-header">
          ...
          <div>
            ...
            <p className="student-brand-sub">Portal Dosen</p>
          </div>
        </div>
      ...
      <header className="student-mobile-topbar">
        <div className="student-topbar-left">
          ...
          <div>
            ...
            <p className="student-mobile-subtitle">Portal Dosen</p>
          </div>
        </div>
      ...
      {/* --- MAIN CONTENT AREA --- */}
      <main className="student-main-content bg-slate-50">
